...
public class DataLogicCustomers extends BeanFactoryDataSingle {
    ...
    public SentenceList getAddonProduct(String product) {
        return new StaticSentence(s,
                "SELECT P.ID, P.REFERENCE, P.CODE, P.NAME, P.ISCOM, P.ISSCALE, P.PRICEBUY, P.PRICESELL, P.TAXCAT, P.CATEGORY, P.ATTRIBUTESET_ID, P.IMAGE, P.ATTRIBUTES, P.ITEMCODE, P.MRP,'',P.PRODUCTTYPE,P.PRODUCTIONAREATYPE,P.SERVICECHARGE,P.SERVICETAX,C.PARENTID,P.PREPARATIONTIME ,P.SWACHBHARATTAX,ISCOMBOPRODUCT,P.STATION "
    ...
    public SentenceList getMenuAddonProduct(String product, String menuId) {
        return new StaticSentence(s,
                "SELECT P.ID, P.REFERENCE, P.CODE, P.NAME, P.ISCOM, P.ISSCALE, M.PRICEBUY, M.PRICESELL, P.TAXCAT, P.CATEGORY, P.ATTRIBUTESET_ID, P.IMAGE, P.ATTRIBUTES, P.ITEMCODE, M.MRP,'',P.PRODUCTTYPE,P.PRODUCTIONAREATYPE,P.SERVICECHARGE,P.SERVICETAX,C.PARENTID,P.PREPARATIONTIME,P.SWACHBHARATTAX,ISCOMBOPRODUCT,P.STATION  "
